  ...
  module Strategies
    class Keycloak < OmniAuth::Strategies::OAuth2
      ...
      def setup_phase
        ...
        return unless @authorize_url.nil? || @token_url.nil?
        ...
        config_url = URI.join(
          site, "#{auth_url_base}/realms/#{realm}/.well-known/openid-configuration"
        )
      ...
      def auth_url_base
        ...
        raise ConfigurationError,
              "Keycloak base_url option should start with '/'. Current value: #{base_url}"
      end
